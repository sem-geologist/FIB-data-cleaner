...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_6.addWidget(self.transparency_slider, 1, 8, 1, 1)
        self.slice_iv = ImageView(self.groupBox)
        self.slice_iv.setObjectName("slice_iv")
        self.gridLayout_6.addWidget(self.slice_iv, 0, 0, 1, 9)
        self.lock_text = QtWidgets.QLabel(self.groupBox)
        self.lock_text.setObjectName("lock_text")
        self.gridLayout_6.addWidget(self.lock_text, 1, 6, 1, 1)
        self.check_box_blacklisted = QtWidgets.QCheckBox(self.groupBox)
        self.check_box_blacklisted.setFocusPolicy(QtCore.Qt.NoFocus)
        self.check_box_blacklisted.setObjectName("check_box_blacklisted")
        self.gridLayout_6.addWidget(self.check_box_blacklisted, 1, 3, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.slice_lock, 1, 5, 1, 1)
        ...
        self.cb_treeview_source = QtWidgets.QComboBox(self.widget)
        ...
        self.cb_treeview_source.addItem("")
        self.cb_treeview_source.addItem("")
        self.verticalLayout_2.addWidget(self.cb_treeview_source)
        self.tv_metadata = DataTreeWidget(self.widget)
        self.tv_metadata.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.tv_metadata.sizePolicy().hasHeightForWidth())
        self.tv_metadata.setSizePolicy(sizePolicy)
        ...
        self.verticalLayout_2.addWidget(self.tv_metadata)
        self.pw_metadata = PlotWidget(self.splitter_4)
        self.pw_metadata.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(5)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pw_metadata.sizePolicy().hasHeightForWidth())
        self.pw_metadata.setSizePolicy(sizePolicy)
        ...
        self.gridLayout_5.addWidget(self.pb_stack_in_arrays, 1, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.pb_destroy_stack_elements, 1, 1, 1, 1)
        ...
        self.init_slice_btn = QtWidgets.QPushButton(self.widget1)
        ...
        self.reset_matrix = QtWidgets.QPushButton(self.widget1)
        ...
        self.comboMatrixMode = QtWidgets.QComboBox(self.widget1)
        ...
        self.pushMultiplyMatrices = QtWidgets.QPushButton(self.widget1)
        ...
        self.gridLayout.addWidget(self.widget1, 0, 2, 2, 1)
        ...
        self.mtv = QtWidgets.QTableView(self.widget_3)
        ...
        self.mtv.horizontalHeader().setDefaultSectionSize(40)
        self.mtv.horizontalHeader().setMinimumSectionSize(20)
        self.mtv.verticalHeader().setDefaultSectionSize(24)
        self.mtv.verticalHeader().setMinimumSectionSize(16)
        self.horizontalLayout_2.addWidget(self.mtv)
        self.multi_mtv = QtWidgets.QTableView(self.widget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.multi_mtv.sizePolicy().hasHeightForWidth())
        self.multi_mtv.setSizePolicy(sizePolicy)
        self.multi_mtv.setMinimumSize(QtCore.QSize(100, 100))
        self.multi_mtv.setCornerButtonEnabled(False)
        self.multi_mtv.setObjectName("multi_mtv")
        self.multi_mtv.horizontalHeader().setDefaultSectionSize(40)
        self.multi_mtv.horizontalHeader().setMinimumSectionSize(20)
        self.multi_mtv.verticalHeader().setDefaultSectionSize(24)
        self.multi_mtv.verticalHeader().setMinimumSectionSize(16)
        self.horizontalLayout_2.addWidget(self.multi_mtv)
        ...
        self.strenght_spinbox.setFocusPolicy(QtCore.Qt.NoFocus)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.transparency_slider.setStatusTip(_translate("MainWindow", "left - transparent; right - opaque"))
        ...
        self.check_box_blacklisted.setStatusTip(_translate("MainWindow", "marks the current slice to be removed from stack when cropping."))
        self.check_box_blacklisted.setText(_translate("MainWindow", "blacklisted"))
        ...
        self.slice_lock.setStatusTip(_translate("MainWindow", "(un-) lock (current) slice to be overlayed with adjustable transparency"))
        ...
        self.cb_treeview_source.setStatusTip(_translate("MainWindow", "select which metadata to show in tree view"))
        self.cb_treeview_source.setItemText(0, _translate("MainWindow", "common metadata"))
        self.cb_treeview_source.setItemText(1, _translate("MainWindow", "stack_elements"))
        self.cb_treeview_source.setItemText(2, _translate("MainWindow", "stack_in_arrays"))
        self.pb_stack_in_arrays.setStatusTip(_translate("MainWindow", "stack values from selected metadata branch into array for slices and place into original_metadata"))
        self.pb_stack_in_arrays.setText(_translate("MainWindow", "push selected to stack_as_arrays"))
        self.pb_destroy_stack_elements.setStatusTip(_translate("MainWindow", "strip the \"stack_elements\" from original_metadata in hyperspy signal"))
        self.pb_destroy_stack_elements.setText(_translate("MainWindow", "Discard stack_elements"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("MainWindow", "Metadata"))
        self.groupBox_4.setTitle(_translate("MainWindow", "Affine Transformation Correction"))
        self.init_slice_btn.setStatusTip(_translate("MainWindow", "init affine matrix transformation for current slice"))
        self.init_slice_btn.setText(_translate("MainWindow", "init for slice"))
        self.init_slice_btn.setShortcut(_translate("MainWindow", "Ctrl+I"))
        self.pin_points_to_slice.setStatusTip(_translate("MainWindow", "Toggle \"sticked\" triangle to 3 reference points"))
        self.pin_points_to_slice.setText(_translate("MainWindow", "🖈⨻"))
        self.reset_triangle.setStatusTip(_translate("MainWindow", "reset the matrix to state before matrix modifications by triangle geometry change"))
        self.reset_triangle.setText(_translate("MainWindow", "..."))
        self.show_ref_points.setStatusTip(_translate("MainWindow", "define 3 points for affine transformation \"by triangle\" manipulation"))
        self.show_ref_points.setText(_translate("MainWindow", "3 point def."))
        self.reset_matrix.setStatusTip(_translate("MainWindow", "reset to original geometry"))
        ...
        self.comboMatrixMode.setStatusTip(_translate("MainWindow", "change mode of matrix manipulation."))
        self.comboMatrixMode.setItemText(0, _translate("MainWindow", "modify current"))
        self.comboMatrixMode.setItemText(1, _translate("MainWindow", "pre-multiply selected"))
        self.comboMatrixMode.setItemText(2, _translate("MainWindow", "post-multiply selected"))
        ...
        self.pushMultiplyMatrices.setStatusTip(_translate("MainWindow", "multiply matrices for selected range of slices."))
        self.pushMultiplyMatrices.setText(_translate("MainWindow", "Multiply"))
        self.mtv.setStatusTip(_translate("MainWindow", "affine transformation matrix of current slice"))
        self.multi_mtv.setStatusTip(_translate("MainWindow", "matrix for multiplication"))
        ...
        self.strenght_spinbox.setStatusTip(_translate("MainWindow", "single shift operation strenght"))
        ...
        self.slices_spinbox.setStatusTip(_translate("MainWindow", "number of selected slices for geometry manipulations"))
        self.slices_spinbox.setSuffix(_translate("MainWindow", " sl."))
        self.to_end_checkbox.setStatusTip(_translate("MainWindow", "select all slices between current index and last for geometry manipulations"))
